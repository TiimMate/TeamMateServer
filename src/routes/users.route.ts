...
import { fetchUserProfileByCategory, modifyUserProfile } from "../controllers/users.controller";

export const usersRouter = express.Router();

usersRouter.use(verifyUser);

usersRouter.get("/profiles/:category", validate(readUserProfileSchema), asyncHandler(fetchUserProfileByCategory));
