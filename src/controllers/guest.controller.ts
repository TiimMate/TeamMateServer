...
//     return res.send(response(status.SUCCESS, await readGuestingByLevel(req.team.id, req.query)));
// };

// export const GuestingPreviewByGender = async (req, res, next) => {
//     return res.send(response(status.SUCCESS, await readGuestingByGender(req.team.id, req.query)));
// };

// export const GuestingPreviewByRegion = async (req, res, next) => {
//     return res.send(response(status.SUCCESS, await readGuestingByRegion(req.team.id, req.query)));
// };
