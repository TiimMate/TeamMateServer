...
export const readHostingApplicantsTeamList = async (userId, params) => {
    ...
    const applicantTeamInfo = await getHostingApplicantsTeamInfo(gameId);

    return readHostingApplicantsTeamResponseDTO(applicantTeamInfo);
};
